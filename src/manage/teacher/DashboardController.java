...
public class DashboardController implements Initializable {
    ...
    public static AnchorPane homet, addt, viewt, edit,holdePane;
    @FXML
    ...
    private void createPages() {
        try {
            homet = FXMLLoader.load(getClass().getResource("/manage/teacher/Home.fxml"));
            addt = FXMLLoader.load(getClass().getResource("/manage/teacher/AddTeacher.fxml"));
            viewt = FXMLLoader.load(getClass().getResource("/manage/teacher/OverView.fxml"));
